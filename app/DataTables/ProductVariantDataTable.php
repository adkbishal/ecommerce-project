    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $variantItems=  "<a href='" . route('admin.product-variant-item.index',['productId'=> request()->product,'variantId'=> $query->id]) . "' class='btn btn-primary mr-2'><i class='far fa-edit mr-2'></i>Variant Items</a>";
                ...
                return "<div class='d-flex'>" . $variantItems . $editBtn . $deleteBtn . "</div>";
